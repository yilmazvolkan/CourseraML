...
% 1 is best which is denoted by blue and it converges
 %hold on;
 %theta = zeros(3, 1);
...
price = [1 (1650-mu(1))/sigma(1) (3-mu(2))/sigma(2)]*theta; % 1 for bias, Feature normalize and multiply with theta
% ============================================================
